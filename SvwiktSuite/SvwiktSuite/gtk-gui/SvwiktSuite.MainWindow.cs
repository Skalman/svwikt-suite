...
namespace SvwiktSuite
{
	public partial class MainWindow
	{
		...
		private global::Gtk.Label labelPreferences;
		...
		protected virtual void Build ()
		{
			...
			this.GtkLabel5.LabelProp = global::Mono.Unix.Catalog.GetString ("<b>Före</b>");
			...
			this.GtkLabel6.LabelProp = global::Mono.Unix.Catalog.GetString ("<b>Efter</b>");
			...
			this.labelStart.LabelProp = global::Mono.Unix.Catalog.GetString ("Start");
			this.notebookMain.SetTabLabel (this.vbox2, this.labelStart);
			this.labelStart.ShowAll ();
			// Notebook tab
			global::Gtk.Label w36 = new global::Gtk.Label ();
			w36.Visible = true;
			this.notebookMain.Add (w36);
			this.labelPreferences = new global::Gtk.Label ();
			this.labelPreferences.Name = "labelPreferences";
			this.labelPreferences.LabelProp = global::Mono.Unix.Catalog.GetString ("Inställningar");
			this.notebookMain.SetTabLabel (w36, this.labelPreferences);
			this.labelPreferences.ShowAll ();
